...
nohup python panda_sac.py --domain_name PandaPickAndPlace-v3 --test_mass 3 > PandaPickAndPlace_mass_3_$current_time.out &

# nohup python panda_sac.py --domain_name PandaPush-v3 --test_mass 10 > PandaPush_mass_10_$current_time.out &
nohup python panda_sac.py --domain_name PandaPickAndPlace-v3 --test_mass 4 > PandaPickAndPlace_mass_4_$current_time.out &
